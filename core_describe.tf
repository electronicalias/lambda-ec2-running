...
resource "aws_api_gateway_integration" "instanceIntegration" {
  ...
  type = "AWS"
  uri = "arn:aws:apigateway:${var.run_region}:lambda:path/2015-03-31/functions/${aws_lambda_function.getInstancesLambda.arn}:function:${aws_lambda_function.getInstancesLambda.function_name}/invocations"
